...
function ExploreApps() {
  ...
  return (
    ...
    >
      <div className="border border-[#dfdfdf] dark:border-[#545454] bg-gradient-to-b w-full dark:from-primary py-16 rounded-xl dark:to-[#242424] from-secondary to-[#FAFBFC] px-4 md:px-32">
