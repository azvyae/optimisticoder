    ...
    >
      ...
      <div className="p-6 group-hover:dark:bg-[#1f1f1f] group-hover:bg-[#ececec] grid gap-4">
        <p className="text-sm sm:text-base truncate line-clamp-1">
          <span className="bg-[#000] inline truncate text-light dark:bg-light dark:text-dark rounded-sm px-2">
            {capitalize(story.category)}
          </span>{' '}
          <span className="truncate inline line-clamp-1">{story.readTime}</span>
        </p>
        <h6 className="text-xl sm:text-2xl hover:underline font-bold">
          {story.title}
        </h6>
        <p className="text-[#7d7d7d] text-sm sm:text-base dark:text-[#9d9d9d]">
          {story.excerpt}
        </p>
